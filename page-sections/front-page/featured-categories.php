<div class="custom-container px-[50px] py-[80px]">
   ...
   <div class="">
        <div class="bg-[#12100C] p-[20px] rounded-[10px] border border-[1px] border-[#2d2820] hover:border-[#e7b20d] shadow-[0_4px_6px_rgba(231,178,13,0)] hover:shadow-[2px_6px_6px_rgba(231,178,13,0.5)]">
            <div>
                <h3 class="text-[24px] font-bold">2D & 3D Artist</h3>
            ...
            <div>
                ...
                <a class="gold-text" href="">Explore</a>
            </div>
        </div>
   </div>
</div>